...
\vspace{2pt}
C; C++; Java; C\#; Python; Shell Script; Verilog; HTML; CSS; JavaScript 
...
\begin{itemize} \itemsep -2pt
	...
	\item Developed a backend of a mobile application that is used to charging electric cars. (Java, Postgresql) 
\end{itemize} \vspace{-6pt}
 
{\sl Software Engineer, KB Group} \\
Dhaka, Bangladesh (Apr, 2010 - Sep, 2011)
 \begin{itemize}
 \item  Integrated payment gateways to KB Group e-commerce and post office box applications. (C++, COM, Classic ASP, SQL Server). 
 \item  Implemented a print server that generates PDF tickets and prints them via specialized printers. (C\#, SQL Server)
 \end{itemize} 
...
\begin{itemize}
\item Developed a map client for feature phones for AfriGIS map. Worked on zooming, panning and caching of map tiles. (J2ME, C\#). 
\end{itemize} 
