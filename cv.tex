...
Dhaka, Bangladesh (Apr, 2010 - Sep, 2011)
 \begin{itemize}
 \item  Integrated payment gateways to KB Group e-commerce and box office applications. (C++, COM, Classic ASP, SQL Server).
 \item  Implemented an end-to-end box office ticketing system. (C\#, SQL Server)
 \end{itemize} 
