...
\begin{itemize}
   ...
   \item \textbf{MD Iftakharul Islam}, Javed I Khan "A Network-centric TCP for Interactive Video Delivery Networks (VDN)." IEEE ICNP Workshop PVE-SDN, 2017.		      
   \item \textbf{MD Iftakharul Islam}, Javed I Khan "Video Splicing Techniques for P2P Video Streaming." IEEE ICDCS Workshop CNERT, 2015.
