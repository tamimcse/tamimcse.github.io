...
{\sl BSc}, Computer Science and Engineering (Jan 2008) \\ % \sl will be bold italic in
...
\section{\centerline{ OPEN SOURCE PROJECTS}}
 Linux Kernel, Bambu (High-level synthesis), OpenROAD (EDA), Mininet (Network emulator), GStreamer 
\vspace{2pt}
