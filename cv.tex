...
\vspace{10pt}
\begin{itemize}
   \item \textbf{MD Iftakharul Islam}, Javed I Khan "SAIL Based FIB Lookup in a Programmable Pipeline Based Linux Router." IEEE HPSR, 2019.
   \item \textbf{MD Iftakharul Islam}, Javed I Khan "Leveraging Domino to Implement RCP in a Stateful Programmable Pipeline." IEEE HPSR, 2019.
   \item \textbf{MD Iftakharul Islam}, Javed I Khan "A Network-centric TCP for Interactive Video Delivery Networks (VDN)." IEEE ICNP PVE-SDN workshop, 2017.		      
   \item \textbf{MD Iftakharul Islam}, Javed I Khan "Video Splicing Techniques for P2P Video Streaming." IEEE ICDCS CNERT workshop, 2015.
