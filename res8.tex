...
\address{
  Github: \url{https://github.com/tamimcse/}\\
  Website: \url{http://web.cs.kent.edu/~mislam4/}}      
...
Kent State University, Kent, OH, USA. \hspace{0.2in}  GPA 3.82 \hfill 2018 (expected) \\
Thesis - A Router-centric TCP for Interactive Video Delivery Networks (VDN)
