...
\begin{document}
\name{MD I. I\MakeLowercase{slam} (T\MakeLowercase{amim})}
...
%\cvtag{JavaScript}
\\
\cvsection{Current Interest}
\cvtag{Compiler for hardware accelerators}
\cvtag{High-Level Synthesis}
\cvtag{Electronic Design Automation (EDA)}
\cvtag{FPGA}
%\divider
