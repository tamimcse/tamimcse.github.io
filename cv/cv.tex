...
\personalinfo{%
  ...
  \email{tamimkentstate@gmail.com}
 \phone{330-389-3188}
...
\begin{itemize}
	...
	\item It was designed as a GCC plugin. It takes intermediate code produced by GCC as an input and generates a control and data-flow graph (CDFG) for that. It then performs scheduling and MUX tree generation before producing the Verilog code.
	\item Evaluated the generated Verilog code with iVerilog and OpenROAD 
\end{itemize}
\smallskip
...
\begin{itemize}
	...
	\item Evaluated the algorithms with the routes from real core routers.
\end{itemize}
\smallskip
...
\begin{itemize}
	...
	\item Evaluated the protocols for a video streaming applications for various network topologies using Mininet and a GStreamer. 
\end{itemize}
