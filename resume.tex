...
Kent State University, Kent, OH, USA. \hspace{0.2in}  GPA 3.82 \hfill 2019 (expected) 

 
{\sl Bachelor of Science}, Computer Science and Engineering \\ % \sl will be bold italic in
					 % New Century Schoolbook (or
					 % any postscript font) and
					 % just slanted in Computer
					 % Modern (default) font
Bangladesh University of Engineering and Technology (BUET), Dhaka, Bangladesh      \hfill    Jan 2008

\vspace{0.001in} 
\section{\centerline{ PROGRAMMING SKILLS }}
\vspace{2pt} 
C; Linux Kernel; C++; Java; C\#; Python 
